...
# MAGIC )
# MAGIC USING DELTA
# MAGIC LOCATION '/mnt/silver/encounters';

# COMMAND ----------

# MAGIC %sql
# MAGIC -- Update old record to implement SCD Type 2
# MAGIC MERGE INTO hive_metastore.default.encounters AS target
...
# MAGIC MERGE INTO hive_metastore.default.encounters AS target USING quality_checks AS source ON target.EncounterID = source.EncounterID
...
# MAGIC %sql
# MAGIC select SRC_EncounterID,datasource,count(patientid) from  hive_metastore.default.encounters
# MAGIC group by all
