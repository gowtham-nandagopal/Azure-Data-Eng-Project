...
# MAGIC %sql
# MAGIC CREATE TABLE IF NOT EXISTS cptcodes (
...
# MAGIC )
# MAGIC USING DELTA
# MAGIC LOCATION '/mnt/silver/cptcodes';

# COMMAND ----------

# MAGIC %sql
# MAGIC -- Update old record to implement SCD Type 2
# MAGIC MERGE INTO hive_metastore.default.cptcodes AS target
...
# MAGIC %sql
# MAGIC select * from  hive_metastore.default.cptcodes
